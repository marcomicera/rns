...
/**
 * A list of generic places in the RNS system
 **/
@ApiModel(description = "A list of generic places in the RNS system")
public class GenericPlaces   {
   ...
   * minimum: 1
   **/
  public GenericPlaces totalPages(Integer totalPages) {
 ...
 @Min(1)  public Integer getTotalPages() {
   ...
   * minimum: 0
   **/
  public GenericPlaces page(Integer page) {
    this.page = page;
    return this;
  }
 ...
 @Min(0)  public Integer getPage() {
   ...
   **/
  public GenericPlaces next(URI next) {
    this.next = next;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    GenericPlaces genericPlaces = (GenericPlaces) o;
    return Objects.equals(this.totalPages, genericPlaces.totalPages) &&
        Objects.equals(this.page, genericPlaces.page) &&
        Objects.equals(this.next, genericPlaces.next);
  }
