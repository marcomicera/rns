...
/**
 * List of parking areas in the RNS system
 **/
@ApiModel(description = "List of parking areas in the RNS system")
public class ParkingAreas   {
   ...
   * minimum: 1
   **/
  public ParkingAreas totalPages(Integer totalPages) {
 ...
 @Min(1)  public Integer getTotalPages() {
   ...
   * minimum: 0
   **/
  public ParkingAreas page(Integer page) {
    this.page = page;
    return this;
  }
 ...
 @Min(0)  public Integer getPage() {
   ...
   **/
  public ParkingAreas next(URI next) {
    this.next = next;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ParkingAreas parkingAreas = (ParkingAreas) o;
    return Objects.equals(this.totalPages, parkingAreas.totalPages) &&
        Objects.equals(this.page, parkingAreas.page) &&
        Objects.equals(this.next, parkingAreas.next);
  }
